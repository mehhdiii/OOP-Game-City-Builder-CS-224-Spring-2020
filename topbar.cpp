...
void Topbar::setRect(){
    ...
    text_objects[1]->setCoordinates(826 -20, xplevel_mover.y );//+xplevel_mover.w

    text_objects[2]->setCoordinates(519-20, greenenergy_mover.y);//+greenenergy_mover.w
    text_objects[3]->setCoordinates(180, cash_mover.y ); //+cash_mover.w
