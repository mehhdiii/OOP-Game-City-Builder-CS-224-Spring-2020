...
void Bank::loan(int& main_cash){  // it gives the user the option to take loan from the bank on interest
    if (active_loan == false){      // if the player hasn't taken a loan previously then give a loan
        ...
        if (loan_required == 2500){
            ...
            main_cash += 2500;    // it gives a loan of twenty five hundred to the user.
            ...
            deadline_time = loan_taken_time + time_margin_given;
            main_cash += 5000;    // it gives a loan of five thousand to the user.
            ...
            deadline_time = loan_taken_time + time_margin_given;
            main_cash += 7500;    // it gives a loan of seventy five hundred to the user.
...
bool Bank::check_outstanding_loan(){
    if (active_loan == true){
        ...
        if (current_time >= deadline_time){
            ...
            return true; // you can not buy any thing now..
        }
        else {
            return false; // you still have time to pay the loan.
        }
    }
    else{
